...
COLUMN_PREFIXES = ('Операция_', 'Содержание_', 'Документ_', 'Аналитика Дт_', 'Субконто Дт_', 'Аналитика Кт_', 'Субконто Кт_')
...
def print_instruction_color(type_registr: Literal['posting', 'card']) -> None:
    """Выводит цветную инструкцию по использованию программы"""
    REGISTER_DISPLAY_NAMES = {'posting': 'Отчета по проводкам',
                              'card': 'Карточки счета'}
    REGISTER_HEADERS_MAP = {'posting': ['|Дата|Документ|Содержание|',
